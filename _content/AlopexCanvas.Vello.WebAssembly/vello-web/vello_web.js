/* @ts-self-types="./vello_web.d.ts" */

export class VelloWebRenderer {
    static __wrap(ptr) {
        const obj = Object.create(VelloWebRenderer.prototype);
        obj.__wbg_ptr = ptr;
        VelloWebRendererFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        VelloWebRendererFinalization.unregister(this);
        return ptr;
    }
    free() {
     ...
     * @param {number} stroke_cap
     * @param {number} stroke_join
     * @param {number} r
     * @param {number} g
     * @param {number} b
     * @param {number} a
     ...
     * @param {number} m32
     */
    direct_draw_circle(cx, cy, radius, style, stroke_width, stroke_cap, stroke_join, r, g, b, a, m11, m12, m21, m22, m31, m32) {
        const ret = wasm.vellowebrenderer_direct_draw_circle(this.__wbg_ptr, cx, cy, radius, style, stroke_width, stroke_cap, stroke_join, r, g, b, a, m11, m12, m21, m22, m31, m32);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {number} m32
     */
    direct_draw_line(x1, y1, x2, y2, stroke_width, stroke_cap, stroke_join, r, g, b, a, m11, m12, m21, m22, m31, m32) {
        const ret = wasm.vellowebrenderer_direct_draw_line(this.__wbg_ptr, x1, y1, x2, y2, stroke_width, stroke_cap, stroke_join, r, g, b, a, m11, m12, m21, m22, m31, m32);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {number} m32
     */
    direct_draw_oval(x, y, width, height, style, stroke_width, stroke_cap, stroke_join, r, g, b, a, m11, m12, m21, m22, m31, m32) {
        const ret = wasm.vellowebrenderer_direct_draw_oval(this.__wbg_ptr, x, y, width, height, style, stroke_width, stroke_cap, stroke_join, r, g, b, a, m11, m12, m21, m22, m31, m32);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {number} m32
     */
    direct_draw_path(path_id, style, stroke_width, stroke_cap, stroke_join, r, g, b, a, m11, m12, m21, m22, m31, m32) {
        const ret = wasm.vellowebrenderer_direct_draw_path(this.__wbg_ptr, path_id, style, stroke_width, stroke_cap, stroke_join, r, g, b, a, m11, m12, m21, m22, m31, m32);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {number} m32
     */
    direct_draw_rect(x, y, width, height, style, stroke_width, stroke_cap, stroke_join, r, g, b, a, m11, m12, m21, m22, m31, m32) {
        const ret = wasm.vellowebrenderer_direct_draw_rect(this.__wbg_ptr, x, y, width, height, style, stroke_width, stroke_cap, stroke_join, r, g, b, a, m11, m12, m21, m22, m31, m32);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {number} width
     * @param {number} height
     * @param {number} top_left_radius
     * @param {number} top_right_radius
     * @param {number} bottom_right_radius
     * @param {number} bottom_left_radius
     * @param {number} style
     * @param {number} stroke_width
     * @param {number} stroke_cap
     * @param {number} stroke_join
     ...
     * @param {number} m32
     */
    direct_draw_round_rect(x, y, width, height, top_left_radius, top_right_radius, bottom_right_radius, bottom_left_radius, style, stroke_width, stroke_cap, stroke_join, r, g, b, a, m11, m12, m21, m22, m31, m32) {
        const ret = wasm.vellowebrenderer_direct_draw_round_rect(this.__wbg_ptr, x, y, width, height, top_left_radius, top_right_radius, bottom_right_radius, bottom_left_radius, style, stroke_width, stroke_cap, stroke_join, r, g, b, a, m11, m12, m21, m22, m31, m32);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    direct_draw_text_with_brush(text, x, y, align, family_name, weight, size, brush_kind, r, g, b, a, p0x, p0y, p1x, p1y, radius, start_angle, end_angle, spread, stop_offsets, stop_colors, image_id_high, image_id_low, tile_mode, stretch, align_x, align_y, has_bounds, bounds_x, bounds_y, bounds_width, bounds_height, m11, m12, m21, m22, m31, m32) {
        ...
        const ptr1 = passStringToWasm0(family_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArray8ToWasm0(stop_offsets, wasm.__wbindgen_malloc);
     ...
     * @param {number} path_id
     */
    direct_drop_path(path_id) {
        wasm.vellowebrenderer_direct_drop_path(this.__wbg_ptr, path_id);
    }
    direct_end_element() {
        const ret = wasm.vellowebrenderer_direct_end_element(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    direct_end_frame_graph() {
        const ret = wasm.vellowebrenderer_direct_end_frame_graph(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {number} radius
     */
    direct_path_arc_to(path_id, x1, y1, x2, y2, radius) {
        const ret = wasm.vellowebrenderer_direct_path_arc_to(this.__wbg_ptr, path_id, x1, y1, x2, y2, radius);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {number} path_id
     */
    direct_path_close(path_id) {
        const ret = wasm.vellowebrenderer_direct_path_close(this.__wbg_ptr, path_id);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {number} ty
     */
    direct_path_cubic_to(path_id, x, y, cx, cy, tx, ty) {
        const ret = wasm.vellowebrenderer_direct_path_cubic_to(this.__wbg_ptr, path_id, x, y, cx, cy, tx, ty);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {number} y
     */
    direct_path_line_to(path_id, x, y) {
        const ret = wasm.vellowebrenderer_direct_path_line_to(this.__wbg_ptr, path_id, x, y);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {number} y
     */
    direct_path_move_to(path_id, x, y) {
        const ret = wasm.vellowebrenderer_direct_path_move_to(this.__wbg_ptr, path_id, x, y);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {number} y
     */
    direct_path_quad_to(path_id, cx, cy, x, y) {
        const ret = wasm.vellowebrenderer_direct_path_quad_to(this.__wbg_ptr, path_id, cx, cy, x, y);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {number} m32
     */
    direct_push_clip_path(path_id, m11, m12, m21, m22, m31, m32) {
        const ret = wasm.vellowebrenderer_direct_push_clip_path(this.__wbg_ptr, path_id, m11, m12, m21, m22, m31, m32);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {number} m32
     */
    direct_push_clip_rect(x, y, width, height, m11, m12, m21, m22, m31, m32) {
     ...
     */
    direct_render(background_r, background_g, background_b, background_a) {
        const ret = wasm.vellowebrenderer_direct_render(this.__wbg_ptr, background_r, background_g, background_b, background_a);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    dispose() {
        wasm.vellowebrenderer_dispose(this.__wbg_ptr);
    }
    /**
     * @param {string} family_name
     * @param {string} text
     ...
     */
    resize(width, height) {
        const ret = wasm.vellowebrenderer_resize(this.__wbg_ptr, width, height);
        return ret;
    }
}
if (Symbol.dispose) VelloWebRenderer.prototype[Symbol.dispose] = VelloWebRenderer.prototype.free;
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_vellowebrenderer_new: function(arg0) {
            const ret = VelloWebRenderer.__wrap(arg0);
            return ret;
        },
...
const VelloWebRendererFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_vellowebrenderer_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('vello_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
